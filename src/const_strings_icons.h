...
namespace strings {
    ...
    namespace categoryIcons {
        ...
        inline const QIcon &forDriver(const QString &driver) {
            ...
            // HID/Input drivers
            if (driver == QStringLiteral("hid-multitouch") ||
                driver == QStringLiteral("hid-generic") ||
                driver == QStringLiteral("hid-apple") ||
                driver == QStringLiteral("hid-logitech") ||
                driver == QStringLiteral("hid-logitech-hidpp") ||
                driver == QStringLiteral("usbhid") ||
                driver == QStringLiteral("i2c_hid_acpi"))
                return hid();

            // Keyboard drivers
            if (driver == QStringLiteral("atkbd") ||
                driver == QStringLiteral("i8042"))
                return keyboards();

            // Mouse/touchpad drivers
            if (driver == QStringLiteral("psmouse") ||
                driver == QStringLiteral("elan_i2c") ||
                driver == QStringLiteral("synaptics"))
                return mice();

            // Graphics drivers
            if (driver == QStringLiteral("i915") ||
                driver == QStringLiteral("nvidia") ||
                driver == QStringLiteral("nvidia-gpu") ||
                driver == QStringLiteral("nouveau") ||
                driver == QStringLiteral("amdgpu") ||
                driver == QStringLiteral("radeon"))
                return displayAdapters();

            // Network drivers (wired)
            if (driver == QStringLiteral("r8169") ||
                driver == QStringLiteral("e1000e") ||
                driver == QStringLiteral("igb") ||
                driver == QStringLiteral("igc"))
                return networkAdapters();

            // Network drivers (wireless)
            if (driver == QStringLiteral("iwlwifi") ||
                driver == QStringLiteral("ath9k") ||
                driver == QStringLiteral("ath10k_pci") ||
                driver == QStringLiteral("ath11k_pci") ||
                driver == QStringLiteral("rtw88_pci") ||
                driver == QStringLiteral("rtw89_pci") ||
                driver == QStringLiteral("mt7921e") ||
                driver == QStringLiteral("brcmfmac"))
                return networkWireless();

            // Storage drivers
            if (driver == QStringLiteral("nvme") ||
                driver == QStringLiteral("ahci") ||
                driver == QStringLiteral("sd") ||
                driver == QStringLiteral("uas") ||
                driver == QStringLiteral("usb-storage"))
                return diskDrives();

            // Card reader drivers
            if (driver == QStringLiteral("rtsx_pci") ||
                driver == QStringLiteral("sdhci-pci"))
                return cardReader();
            ...
            if (driver == QStringLiteral("snd_hda_intel") ||
                ...
                driver == QStringLiteral("snd_hda_codec_hdmi") ||
                driver == QStringLiteral("snd_usb_audio"))
                return audioInputs();
            ...
            // Bluetooth drivers
            if (driver == QStringLiteral("btusb") ||
                driver == QStringLiteral("btintel") ||
                driver == QStringLiteral("btrtl") ||
                driver == QStringLiteral("btmtk"))
                return bluetooth();

            // USB host controllers
            if (driver == QStringLiteral("xhci_hcd") ||
                driver == QStringLiteral("ehci-pci") ||
                driver == QStringLiteral("ohci-pci") ||
                driver == QStringLiteral("uhci_hcd"))
                return usbControllers();
            ...
            if (driver == QStringLiteral("proc_thermal") ||
                driver == QStringLiteral("processor") ||
                driver == QStringLiteral("acpi-cpufreq") ||
                driver == QStringLiteral("intel_pstate"))
                return processors();

            // System/platform drivers (SMBus, SPI, LPSS, MEI, etc.)
            if (driver == QStringLiteral("i801_smbus") ||
                driver == QStringLiteral("i2c_designware") ||
                driver == QStringLiteral("intel-lpss") ||
                driver == QStringLiteral("intel-spi") ||
                driver == QStringLiteral("intel-vsec") ||
                driver == QStringLiteral("mei_me") ||
                driver == QStringLiteral("pcieport") ||
                driver == QStringLiteral("pci-stub") ||
                driver == QStringLiteral("portdrv") ||
                driver == QStringLiteral("shpchp") ||
                driver == QStringLiteral("serial8250") ||
                driver == QStringLiteral("dw-apb-uart") ||
                driver == QStringLiteral("hub") ||
                driver == QStringLiteral("rtc_cmos"))
                return systemDevices();
